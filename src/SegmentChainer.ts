...
export function SegmentChainer(
  ...
  for (const segb of segments) {
    ...
    type Match = { index: number; startMatch: boolean | undefined; endMatch: boolean | undefined };

    // search for two chains that this segment matches
    let firstMatch: Match | undefined;
    let secondMatch: Match | undefined;
    ...
    if (firstMatch == null) {
      ...
      log?.chainConnect(firstMatch.index, secondMatch.index, closed);
