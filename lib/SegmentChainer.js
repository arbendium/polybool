...
export function SegmentChainer(segments, geo) {
	...
	segments = segments.toSorted((segA, segB) => geo.compareVec2(segA.data.p0, segB.data.p0)
		|| (segA.data.p1[0] - segB.data.p1[0])
			* (segA.data.p0[1] - segB.data.p1[1])
			- (segA.data.p1[1] - segB.data.p1[1])
			* (segA.data.p0[0] - segB.data.p1[0]));
